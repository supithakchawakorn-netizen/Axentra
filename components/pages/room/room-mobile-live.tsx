...
export function RoomMobileLive({
  room,
  tickers,
  comments,
  demoBanner,
  ...
  return (
    <main className="mx-auto max-w-5xl px-3 py-5">
      ...
      <header className="glass-panel mt-4 rounded-xl border p-4 space-y-3">
        <StatusPill label="Live now" tone="live" className="uppercase tracking-wider" />
        <h1 className="text-xl font-semibold tracking-tight">{room.title}</h1>
        {room.creator ? (
      ...
      <section className="glass-panel mt-5 rounded-xl border p-4 space-y-2">
